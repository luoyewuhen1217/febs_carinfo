package cc.mrbird.common.util.pay;
...
public class PayUtil {
    ...
    public static String alipay(String outTradeNo, String totalAmount, String subject, String body) {
        ...
        try {
            alipayRequest.setBizContent("{\"out_trade_no\":\"" + outTradeNo + "\"," + "\"total_amount\":\"" + totalAmount + "\"," + "\"subject\":\"" + subject + "\"," + "\"timeout_express\":\"90m\"," + "\"body\":\"" + body + "\"," + "\"qr_pay_mode\":\"1\"," + "\"product_code\":\"FAST_INSTANT_TRADE_PAY\"}");
