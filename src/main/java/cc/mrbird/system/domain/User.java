...
public class User implements Serializable {
    ...
    public String toString() {
        return "User{" + "userId=" + userId + ", username='" + username + '\'' + ", password='" + password + '\'' + ", deptId=" + deptId + ", deptName='" + deptName + '\'' + ", email='" + email + '\'' + ", mobile='" + mobile + '\'' + ", status='" + status + '\'' + ", crateTime=" + crateTime + ", modifyTime=" + modifyTime + ", lastLoginTime=" + lastLoginTime + ", ssex='" + ssex + '\'' + ", theme='" + theme + '\'' + ", avatar='" + avatar + '\'' + ", description='" + description + '\'' + ", vipStatus='" + vipStatus + '\'' + ", vipType='" + vipType + '\'' + ", vipTime='" + vipTime + '\'' + ", roleName='" + roleName + '\'' + ", timeField='" + timeField + '\'' + ", timeField1='" + timeField1 + '\'' + ", timeField2='" + timeField2 + '\'' + '}';
    }
}